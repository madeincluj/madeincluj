MIC.MonumentsLayer = {
	...
	item_template: 'tmpl-monument-item',

	geojson_url: 'modules/collection/monuments/json/monuments.json',
	// img_base_url: '../s3/collection/dg/',
	img_base_url: 'http://madeincluj.s3.amazonaws.com/collection/monuments/',
	thumb_dir: 'thumb/',
	large_dir: 'large/',
	...
	metadata: {
		data_name: 'monuments',
		name: 'Monumente',
		description: 'Clădiri importante din oraș.',
		thumbnail_url: '',
	},
	
	item_url : function(feature) {
		return 'modules/collection/monuments/json/metadata/' + feature.properties.id + '.json';
	},
